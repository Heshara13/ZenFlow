...
class MidfullExerciseDetailsPage extends StatelessWidget {
  ...
  const MidfullExerciseDetailsPage({super.key, required this.mindfullExercise});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Mindful Exercise Details')),
      body: SafeArea(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(mindfullExercise.category),
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text('${mindfullExercise.duration} minutes'),
                  ],
                ),
                const SizedBox(height: 20),
                ElevatedButton(
